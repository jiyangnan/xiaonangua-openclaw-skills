...
description: First-time setup flow for xiaonangua-post-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.baoyu-skills/xiaonangua-post-wechat/EXTEND.md` | Current project |
| User | `~/.baoyu-skills/xiaonangua-post-wechat/EXTEND.md` | All projects |
