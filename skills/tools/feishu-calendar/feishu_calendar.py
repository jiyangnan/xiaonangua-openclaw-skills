...
# 飞书配置
APP_ID = os.environ.get("FEISHU_APP_ID", "cli_a9f4843513211bcb")
APP_SECRET = os.environ.get("FEISHU_APP_SECRET", "lML5HSRNjv2DjRSSNcKWfhRAgQ8VGYOP")
CALENDAR_ID = os.environ.get("FEISHU_CALENDAR_ID", "feishu.cn_L21HaOIPmDpbNeguyvMwNb@group.calendar.feishu.cn")
